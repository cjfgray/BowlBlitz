<!doctype html>
<html lang="en" ng-app="authentication">
<head>
                        ...
                        <div ng-show="loginCtrl.type" class="card login-card card-block hide">
                            <div class="row">
                                ...
                                <div class="input-group col-md-12 col-lg-12 col-xl-12">
                                    <input type="text" id="email" class="form-control desktop-input" placeholder="Email" ng-model="loginCtrl.user.email">
                                </div>
                                <div class="input-group col-md-12 col-lg-12 col-xl-12">
                                    <input type="password" id="password" class="form-control desktop-input" placeholder="Password" ng-model="loginCtrl.user.password">
                                </div>
                            </div>
                            <button type="button" class="btn btn-outline-info btn-block action-button" ng-click="loginCtrl.login()">Login</button>
                        </div>
...
<asset:javascript src="loginManifest.js"/>
<asset:javascript src="login/loginController.js"/>
